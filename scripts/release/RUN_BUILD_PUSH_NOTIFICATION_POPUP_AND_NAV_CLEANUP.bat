...
git add -- "frontend/src/App.vue" "frontend/src/components/AppSidebar.vue" "frontend/src/views/account/NotificationsView.vue" "scripts/release/RUN_BUILD_PUSH_NOTIFICATION_POPUP_AND_NAV_CLEANUP.bat"
