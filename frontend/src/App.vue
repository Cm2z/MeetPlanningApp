...
import BackupView from './views/administration/BackupView.vue';
...
import RoomManagementView from './views/administration/RoomManagementView.vue';
import ReserveView from './views/bookings/ReserveView.vue';
import SettingsView from './views/administration/SettingsView.vue';
import StatsView from './views/dashboard/StatsView.vue';
import UserHistoryView from './views/bookings/UserHistoryView.vue';
import UserManagementView from './views/administration/UserManagementView.vue';
